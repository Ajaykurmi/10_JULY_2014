...
/*
	Case 1:
	How much points you have in your plain(In integer)? 3
	Enter value for x1 1
	Enter value for y1 1
	Enter value for x2 0
	Enter value for y2 0
	Enter value for x3 5
	Enter value for y3 5

	Points are coolinear

	Case 2: 
	How much points you have in your plain(In integer)? A

	Wrong input provided only number are allowed, please try form the beginning
